...
public class DescriptionStoreCacheConfiguration {
    ...
    public DescriptionStoreCacheConfiguration(@Value("${description-store.cache.size}") Long descriptionStoreCacheSize,
    ...
    @Bean
    public LoadingCache<Long, DescriptionDTO> descriptionStoreCache() {
